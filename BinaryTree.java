...
public class BinaryTree extends JPanel
{
   ...
   public static void encryptDialog()
   {
      tree = makeTree();
      encryptMode = true;
      frame = new JFrame("Encryption: Binary Tree");
      frame.setSize(500, 275);
      frame.setLocation(500, 300);
      frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      frame.setContentPane(new BinaryTree(oldField, oldResult));
   ...
   public static void decryptDialog()
   {
      tree = makeTree();
      encryptMode = false;
      frame = new JFrame("Decryption: Binary Tree");
      frame.setSize(500, 275);
      frame.setLocation(500, 300);
      frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      frame.setContentPane(new BinaryTree(oldField, oldResult));
   ...
   public BinaryTree(String fieldText, String resultText)
   {
   ...
   public String encrypt(String word)
   {
      ...
      {
         if(bad.indexOf(word.charAt(i)) != -1)
         {
            error = true;
            symbolError = true;
         }
      ...
      if(error == true)
         return"Binary Tree text can't contain numbers or symbols.";
      else
      {
         String encrypted = "";
         for(int i = 0; i < word.length(); i++)
   ...
   public static String decrypt(String word)
   {
      ...
      if(error == true)
         return "Encoded Binary Tree must consist of only 0s and 1s.";
      else
      {
         TreeNode t = tree;
         String decrypted = "";
